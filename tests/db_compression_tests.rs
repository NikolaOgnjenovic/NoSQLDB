...
fn test_compressed_size_vs_uncompressed_100_diff_keys() {
    ...
    db_config.compression_dictionary_path =
        "sstables/test_compressed_size_vs_uncompressed_100_diff_keys/dictionary_c.bin".to_string();
    db_config.sstable_dir += "test_compressed_size_vs_uncompressed_100_diff_keys/uncompressed/";
    db_config.write_ahead_log_dir +=
        "test_compressed_size_vs_uncompressed_100_diff_keys/uncompressed/";
    ...
    db_config.compression_dictionary_path =
        "sstables/test_compressed_size_vs_uncompressed_100_diff_keys/dictionary_u.bin".to_string();
    db_config.sstable_dir =
        "sstables/test_compressed_size_vs_uncompressed_100_diff_keys/compressed/".to_string();
    db_config.write_ahead_log_dir =
        "wal/test_compressed_size_vs_uncompressed_100_diff_keys/uncompressed/".to_string();
    ...
    for i in 0..100 {
        ...
        assert_eq!(value.as_bytes(), get_op.as_ref());
    }
}
...
fn test_compressed_size_vs_uncompressed_50000_diff_keys() {
    ...
    db_config.compression_dictionary_path =
        "sstables/test_compressed_size_vs_uncompressed_50000_diff_keys/dictionary_u.bin"
            .to_string();
    ...
    db_config.compression_dictionary_path =
        "sstables/test_compressed_size_vs_uncompressed_50000_diff_keys/dictionary_c.bin"
            .to_string();
    db_config.sstable_dir =
        "sstables/test_compressed_size_vs_uncompressed_50000_diff_keys/compressed/".to_string();
